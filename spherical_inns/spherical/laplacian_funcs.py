...
https://github.com/deepsphere/deepsphere-pytorch/blob/9ee5d09c7464be35248ad2746266bbe42c593101/deepsphere/utils/laplacian_funcs.py
"""
...
def get_healpix_laplacians(nodes, depth, laplacian_type, k=8):
    ...
    for i in range(depth):
        ...
        G = SphereHealpix(subdivisions, nest=True, k=k)
        G.compute_laplacian(laplacian_type)
        laplacian = prepare_laplacian(G.L)
        laps.append(laplacian)
    return laps[::-1]
